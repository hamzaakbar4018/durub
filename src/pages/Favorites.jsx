...
const Favorites = () => {
  ...
  const favoritePrompts = [
    {
      ...
      description: "إنشاء خطة عمل شاملة لشركتك الناشئة مع توقعات مالية وتحليل مفصل للسوق.",
      category: "أعمال",
      platform: "ChatGPT",
      code: "أريد منك إنشاء خطة عمل مفصلة لشركة ناشئة بها 3 فروع...",
      dateAdded: "2023-04-15",
    },
    {
      id: 2,
      title: "استراتيجية التسويق",
      description: "إنشاء استراتيجية تسويق كاملة لإطلاق منتجك",
      category: "تسويق",
      platform: "ChatGPT",
      code: "قم بإنشاء استراتيجية تسويق شاملة لإطلاق FitTrack Pro في سوق المملكة العربية السعودية...",
      dateAdded: "2023-04-10",
    },
    {
      id: 3,
      ...
      category: "SEO",
      platform: "Claude",
      code: "قم بإجراء بحث عن الكلمات المفتاحية لموقع لياقة بدنية يركز على تمارين المنزل...",
      dateAdded: "2023-04-05",
    },
    {
      id: 7,
      title: "مشهد مدينة مستقبلية",
      description: "إنشاء نص تفصيلي لصورة منظر مدينة مستقبلية",
      category: "فن",
      platform: "MidJourney",
      code: "منظر مدينة مستقبلية مع ناطحات سحاب طويلة، مركبات طائرة، إعلانات ثلاثية الأبعاد، بأسلوب سايبربانك...",
      dateAdded: "2023-03-20",
    },
  ]
  ...
  const handleRemoveFavorite = (id) => {
    // In a real implementation, this would remove the prompt from favorites
    alert(`تمت إزالة النص البرمجي ${id} من المفضلة`)
  }

  const handleCopyPrompt = (code) => {
    navigator.clipboard.writeText(code)
    alert("تم نسخ النص البرمجي إلى الحافظة!")
  }
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredPrompts.map((prompt) => (
            ...
            >
              ...
              <div className="flex justify-between items-start mb-2">
                <h3 className="font-bold text-lg">{prompt.title}</h3>
                <span className="bg-green-100 text-black text-xs px-2 py-1 rounded-full mt-1 mr-2">
                  {prompt.category}
                </span>
              </div>
