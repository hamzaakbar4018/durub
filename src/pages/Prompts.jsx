...
import { Search, Filter, Plus, Copy, X, ArrowLeft, MessageCircle } from 'lucide-react';
  ...
  const prompts = [
    { 
      ...
      inputs: [
        ...
        { id: "branchCount", label: "Number of Branches", type: "number" }
      ]
    },
    { 
      id: 2, 
    ...
    { 
      ...
      inputs: [
        { id: "industryType", label: "Industry Type", type: "text" },
        { id: "topicFocus", label: "Topic Focus", type: "text" }
      ]
    },
    { 
      id: 4, 
      ...
      inputs: [
        { id: "duration", label: "Duration (e.g., 1 month)", type: "text" },
        { id: "platformName", label: "Platform Name", type: "text" },
        { id: "contentTheme", label: "Content Theme", type: "text" }
      ]
    },
    { 
      id: 5, 
      ...
      inputs: [
        ...
        { id: "productPrice", label: "Product Price", type: "text" }
      ]
    },
    { 
      id: 6, 
      ...
      inputs: [
        ...
        { id: "newsletterTopic", label: "Newsletter Topic", type: "text" }
      ]
    }
  ];
      ...
      <div className="container mx-auto p-6">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <button 
            ...
            className="bg-green-500 hover:bg-green-600 text-white px-6 py-2 rounded-lg mb-6"
          >
            Generate Prompt
          </button>
